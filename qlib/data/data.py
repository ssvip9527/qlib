    ...
    def load_calendar(self, freq, future):
        ...
        try:
            ...
            if future:
                ...
                get_module_logger("data").warning(
                    "You can get future calendar by referring to the following document: https://github.com/ssvip9527/qlib/blob/main-cn/scripts/data_collector/contrib/README.md"
                )
